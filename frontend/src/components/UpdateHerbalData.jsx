...
const herbalData = [
  ...
  },
  {
    ...
    recommendations: [
      {
        herb: "Neem",
        usedFor: "Anti-bacterial, reduces acne",
        preparation: "Apply neem paste on affected area",
        dosage: "Once daily",
      },
      {
        herb: "Tea Tree",
        usedFor: "Reduces inflammation and kills acne-causing bacteria",
        preparation: "Apply diluted oil on pimples",
        dosage: "Twice a day",
      },
    ],
  },
  {
    ...
    recommendations: [
      ...
      {
        herb: "Eucalyptus",
        usedFor: "Clears sinuses",
        preparation: "Add oil to hot water and inhale steam",
